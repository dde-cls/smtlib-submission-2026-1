...
;; rev Z
(declare-fun |rev Z| (|POW (Z x Z)|) |POW (Z x Z)|)
(assert (!
    (forall ((s |POW (Z x Z)|))
      (!
        (= (|rev Z| s)
...
(assert (!
    (not
      (= (|rev Z| (|set.intent (Z x Z)| (lambda ((_c0 |(Z x Z)|)) (or (= _c0 (maplet 1 2))(= _c0 (maplet 2 3))(= _c0 (maplet 3 4)))))) (|set.intent (Z x Z)| (lambda ((_c0 |(Z x Z)|)) (or (= _c0 (maplet 1 4))(= _c0 (maplet 2 3))(= _c0 (maplet 3 2)))))))
    :named |Goal|))
(check-sat)
(exit)
