...
(assert (!
    (not
      (= (|rev Z| (|set.intent (Z x Z)| (lambda ((_c0 |(Z x Z)|)) (or (= _c0 (maplet 1 2))(= _c0 (maplet 2 3))(= _c0 (maplet 3 4)))))) (|set.intent (Z x Z)| (lambda ((_c0 |(Z x Z)|)) (or (= _c0 (maplet 1 3))(= _c0 (maplet 2 4))(= _c0 (maplet 3 5)))))))
    :named |Goal|))
(check-sat)
(exit)
