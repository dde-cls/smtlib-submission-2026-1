...
(define-fun |tail Z| ((s |POW (Z x Z)|)) |POW (Z x Z)| (|↓ Z| s 1))
(assert (!
    (not
      (= (|tail Z| (|set.intent (Z x Z)| (lambda ((_c0 |(Z x Z)|)) (or (= _c0 (maplet 1 2))(= _c0 (maplet 2 3))(= _c0 (maplet 3 4)))))) (|set.intent (Z x Z)| (lambda ((_c0 |(Z x Z)|)) (= _c0 (maplet 1 2))))))
    :named |Goal|))
(check-sat)
(exit)
