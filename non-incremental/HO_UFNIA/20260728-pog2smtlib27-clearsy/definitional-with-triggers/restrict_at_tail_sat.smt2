...
Application: restrict_at_tail_test
Target solver: cvc5
Time limit: 0.1
...
(assert (!
    (not
      (= (|↓ Z| (|set.intent (Z x Z)| (lambda ((_c0 |(Z x Z)|)) (or (= _c0 (maplet 1 0))(= _c0 (maplet 2 1))(= _c0 (maplet 3 2))(= _c0 (maplet 4 3))))) 3) (|set.intent (Z x Z)| (lambda ((_c0 |(Z x Z)|)) (or (= _c0 (maplet 1 2))(= _c0 (maplet 2 3)))))))
    :named |Goal|))
(check-sat)
(exit)
