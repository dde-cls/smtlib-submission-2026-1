...
(assert (! (forall ((t |POW Z|))
    (= (|finite sub-sets Z| t) (|set.intent POW Z| (lambda ((s |POW Z|))
...
(assert (!
(forall ((t |POW Z|)) (= (|non empty finite sub-sets Z| t) (|set.intent POW Z| (lambda ((s |POW Z|))
(and (|set.in POW Z| s (|finite sub-sets Z| t)) (not (= s |set.empty Z|)))))))
