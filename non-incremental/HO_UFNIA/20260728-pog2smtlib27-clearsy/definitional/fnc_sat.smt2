...
(= (|fnc Z POW Z| r) (|set.intent (Z x POW POW Z)| (lambda ((p |(Z x POW POW Z)|))
(and (exists ((y |POW Z|))
(|set.in (Z x POW Z)| (maplet (fst p) y) r)) (forall ((y |POW Z|))
(= (|set.in POW Z| y (snd p)) (|set.in (Z x POW Z)| (maplet (fst p) y) r))))))))
