...
Application: restrict_in_front_test
Target solver: cvc5
Time limit: 0.31
...
(assert (!
    (not
      (= (|↑ Z| (|set.intent (Z x Z)| (lambda ((_c0 |(Z x Z)|)) (or (= _c0 (maplet 1 0))(= _c0 (maplet 2 5))(= _c0 (maplet 3 4))))) 2) (|set.intent (Z x Z)| (lambda ((_c0 |(Z x Z)|)) (= _c0 (maplet 1 4))))))
    :named |Goal|))
(check-sat)
(exit)
