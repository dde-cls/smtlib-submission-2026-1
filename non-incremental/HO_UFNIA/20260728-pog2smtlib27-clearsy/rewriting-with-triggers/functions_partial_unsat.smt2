...
Application: functions_partial_test
Target solver: cvc5
Time limit: 0.31
...
(assert (!
    (not
      (|set.in POW (Z x Z)| (|set.intent (Z x Z)| (lambda ((_c0 |(Z x Z)|)) (or (= _c0 (maplet 1 2))(= _c0 (maplet 2 3))))) (|functions.partial Z Z| (|set.intent Z| (lambda ((_c0 |Z|)) (or (= _c0 1)(= _c0 2)(= _c0 3)))) (|set.intent Z| (lambda ((_c0 |Z|)) (or (= _c0 2)(= _c0 3)(= _c0 4)))))))
    :named |Goal|))
(check-sat)
(exit)
