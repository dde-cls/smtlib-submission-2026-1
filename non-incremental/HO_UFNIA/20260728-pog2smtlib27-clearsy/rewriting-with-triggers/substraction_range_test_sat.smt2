...
(assert (!
    (not
      (= (|rel.subtract.ran Z Z| (|set.intent (Z x Z)| (lambda ((_c0 |(Z x Z)|)) (or (= _c0 (maplet 3 4))(= _c0 (maplet 4 5))))) (|set.intent Z| (lambda ((_c0 |Z|)) (or (= _c0 4)(= _c0 3))))) (|set.intent (Z x Z)| (lambda ((_c0 |(Z x Z)|)) (= _c0 (maplet 3 4))))))
    :named |Goal|))
(check-sat)
(exit)
