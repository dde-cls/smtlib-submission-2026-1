...
(assert (!
    (not
      (= (|rel.restrict.dom Z Z| (|set.intent Z| (lambda ((_c0 |Z|)) (= _c0 4))) (|set.intent (Z x Z)| (lambda ((_c0 |(Z x Z)|)) (or (= _c0 (maplet 2 3))(= _c0 (maplet 4 5)))))) (|set.intent (Z x Z)| (lambda ((_c0 |(Z x Z)|)) (= _c0 (maplet 2 3))))))
    :named |Goal|))
(check-sat)
(exit)
