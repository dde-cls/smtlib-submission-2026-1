...
(assert (!
  (forall ((e1 |POW Z|) (e2 |POW Z|) (f |POW (Z x Z)|))
    (! (= (|set.in POW (Z x Z)| f (|surjections.partial Z Z| e1 e2))
       ...
       :pattern ((|set.in POW (Z x Z)| f (|surjections.partial Z Z| e1 e2)))))
  :named |ax:def.psurj (Z x Z)|))
(assert (!
    (not
      (|set.in POW (Z x Z)| (|set.intent (Z x Z)| (lambda ((_c0 |(Z x Z)|)) (or (= _c0 (maplet 1 2))(= _c0 (maplet 2 2))))) (|surjections.partial Z Z| (|set.intent Z| (lambda ((_c0 |Z|)) (or (= _c0 1)(= _c0 2)(= _c0 3)))) (|set.intent Z| (lambda ((_c0 |Z|)) (or (= _c0 2)(= _c0 3)))))))
    :named |Goal|))
(check-sat)
(exit)
