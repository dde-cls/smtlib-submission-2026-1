...
(assert (!
  (forall ((e |Z|))
    (!
      (= (|set.in Z| e NATURAL)
         (<= 0 e))
      :pattern ((|set.in Z| e NATURAL))))
  :named |ax.set.in.NATURAL|))
(assert (!
    (not
      (|set.in POW (Z x Z)| (|set.intent (Z x Z)| (lambda ((_c0 |(Z x Z)|)) (or (= _c0 (maplet 1 0))(= _c0 (maplet 2 1))(= _c0 (maplet 3 2))(= _c0 (maplet 4 3))))) (|seq Z| NATURAL)))
    :named |Goal|))
(check-sat)
(exit)
