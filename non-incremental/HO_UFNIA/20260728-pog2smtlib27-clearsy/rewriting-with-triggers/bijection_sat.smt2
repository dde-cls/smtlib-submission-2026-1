...
(assert (!
    (not
      (|set.in POW (Z x Z)| (|set.intent (Z x Z)| (lambda ((_c0 |(Z x Z)|)) (= _c0 (maplet 0 1)))) (|bijections.total Z Z| (|set.intent Z| (lambda ((_c0 |Z|)) (= _c0 0))) (|set.intent Z| (lambda ((_c0 |Z|)) (= _c0 0))))))
    :named |Goal|))
(check-sat)
(exit)
