...
(assert (!
    (not
      (|set.in POW (Z x Z)| (|set.intent (Z x Z)| (lambda ((_c0 |(Z x Z)|)) (or (= _c0 (maplet 1 2))(= _c0 (maplet 2 2))))) (|surjections.total Z Z| (|set.intent Z| (lambda ((_c0 |Z|)) (or (= _c0 1)(= _c0 2)))) (|set.intent Z| (lambda ((_c0 |Z|)) (= _c0 2))))))
    :named |Goal|))
(check-sat)
(exit)
