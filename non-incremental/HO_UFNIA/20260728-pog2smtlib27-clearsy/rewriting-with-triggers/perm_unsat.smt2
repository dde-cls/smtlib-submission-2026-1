...
(assert (!
  (forall ((E |POW Z|) (s |POW (Z x Z)|)) (!
    ...
    :pattern ((|set.in POW (Z x Z)| s (|perm Z| E))))
  )
  :named |ax.perm Z|))
(assert (!
    (not
      (|set.in POW (Z x Z)| (|set.intent (Z x Z)| (lambda ((_c0 |(Z x Z)|)) (or (= _c0 (maplet 1 0))(= _c0 (maplet 2 1))(= _c0 (maplet 3 2))))) (|perm Z| (|set.intent Z| (lambda ((_c0 |Z|)) (or (= _c0 0)(= _c0 1)(= _c0 2)))))))
    :named |Goal|))
(check-sat)
(exit)
