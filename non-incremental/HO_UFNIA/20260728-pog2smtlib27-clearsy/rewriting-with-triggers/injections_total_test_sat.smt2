...
Application: injections_total_test
Target solver: cvc5
Time limit: 0.1
...
(assert (!
  (forall ((e1 |POW Z|) (e2 |POW Z|) (f |POW (Z x Z)|)) (!
    ...
    :pattern ( (|set.in POW (Z x Z)| f (|injections.total Z Z| e1 e2)) )))
 :named |ax:def.tinj (Z x Z)|))
(assert (!
    (not
      (|set.in POW (Z x Z)| (|set.intent (Z x Z)| (lambda ((_c0 |(Z x Z)|)) (or (= _c0 (maplet 1 2))(= _c0 (maplet 2 2))))) (|injections.total Z Z| (|set.intent Z| (lambda ((_c0 |Z|)) (or (= _c0 1)(= _c0 2)))) (|set.intent Z| (lambda ((_c0 |Z|)) (or (= _c0 1)(= _c0 2)(= _c0 3)))))))
    :named |Goal|))
(check-sat)
(exit)
